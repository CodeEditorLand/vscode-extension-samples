...
export async function uploadFiddle(
	slug: string,
	version: number,
	html: string,
	js: string,
	...
	if (slug === "demo") {
		...
		const answer = await window.showQuickPick(
			[
				"Yes, open in the browser. I will paste the new Fiddle code, discard changes, refresh source control and checkout latest.",
				"No, I was just clicking around.",
			],
			{
				placeHolder:
