...
export namespace Types.$ {
	export const Operation = new $wcm.EnumType<Types.Operation>([
		"add",
		"sub",
		"mul",
		"div",
	...
	export const Engine = new $wcm.ResourceType<Types.Engine>(
		"engine",
		"vscode:example/types/engine",
	);
...
export namespace calculator._ {
	...
	export type Exports = {
		...
		"vscode:example/types#[method]engine.push-operation": (
			self: i32,
			operation_Operation: i32,
		) => void;
	...
	): Promise<calculator.Exports> | Promise<calculator.Exports.Promisified> {
